 ...
 * @note   @ref SSD1306_UpdateScreen() must be called after that in order to see updated LCD screen_t
 * @param  None
 * @retval None
 */
 ...
 * @note   @ref SSD1306_UpdateScreen() must be called after that in order to see updated LCD screen_t
 * @param  Color: Color to be used for screen_t fill. This parameter can be a value of @ref SSD1306_COLOR_t enumeration
 * @retval None
 */
 ...
 * @note   @ref SSD1306_UpdateScreen() must called after that in order to see updated LCD screen_t
...
// scroll the screen_t for fixed rows
